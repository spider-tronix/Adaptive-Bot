...
def test(agent, env, n_episodes=2, max_t=5000):
...
def open_scene():
    ...
    model_path = os.path.join("Training_Files", model_dir, "Training_0", "target_network_50")
